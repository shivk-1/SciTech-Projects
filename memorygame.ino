...
**********************************************************************
* Program: A memory game that tests the player's ability to recall
* a sequence of button presses and replicate it. The game will provide
* auditory and visual feedback for each round.
**********************************************************************
* Description: This game involves four buttons and LEDs. The system 
* generates a random sequence of button presses. The player must 
* replicate the sequence by pressing the correct buttons. The game 
* continues until the player completes a set number of rounds or makes 
* an error, at which point they lose and the sequence restarts.
**********************************************************************
* Connections: 
* - Buttons: pins 2, 4, 6, 8
* - LEDs: pins 3, 5, 7, 9
* - Buzzer: pin 10
**********************************************************************
*/
